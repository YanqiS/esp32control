...
static const uint8_t *Oled_GetFont(char c)
{
  ...
  static const uint8_t fontColon[5] = {0x00, 0x36, 0x36, 0x00, 0x00};
  static const uint8_t font0[5] = {0x3E, 0x51, 0x49, 0x45, 0x3E};
  static const uint8_t font1[5] = {0x00, 0x42, 0x7F, 0x40, 0x00};
  static const uint8_t font2[5] = {0x42, 0x61, 0x51, 0x49, 0x46};
  static const uint8_t font3[5] = {0x21, 0x41, 0x45, 0x4B, 0x31};
  static const uint8_t fontA[5] = {0x7E, 0x11, 0x11, 0x11, 0x7E};
  static const uint8_t fontC[5] = {0x3E, 0x41, 0x41, 0x41, 0x22};
  static const uint8_t fontE[5] = {0x7F, 0x49, 0x49, 0x49, 0x41};
  static const uint8_t fontF[5] = {0x7F, 0x09, 0x09, 0x09, 0x01};
  static const uint8_t fontH[5] = {0x7F, 0x08, 0x08, 0x08, 0x7F};
  static const uint8_t fontI[5] = {0x00, 0x41, 0x7F, 0x41, 0x00};
  static const uint8_t fontK[5] = {0x7F, 0x08, 0x14, 0x22, 0x41};
  static const uint8_t fontL[5] = {0x7F, 0x40, 0x40, 0x40, 0x40};
  static const uint8_t fontN[5] = {0x7F, 0x04, 0x08, 0x10, 0x7F};
  static const uint8_t fontO[5] = {0x3E, 0x41, 0x41, 0x41, 0x3E};
  static const uint8_t fontP[5] = {0x7F, 0x09, 0x09, 0x09, 0x06};
  static const uint8_t fontR[5] = {0x7F, 0x09, 0x19, 0x29, 0x46};
  static const uint8_t fontS[5] = {0x46, 0x49, 0x49, 0x49, 0x31};
  static const uint8_t fontT[5] = {0x01, 0x01, 0x7F, 0x01, 0x01};
  static const uint8_t fontW[5] = {0x7F, 0x20, 0x18, 0x20, 0x7F};
...
static void Can_Start(void)
{
  ...
  filter.FilterIdHigh = 0x0000;      // 改这里
  filter.FilterIdLow = 0x0000;
  filter.FilterMaskIdHigh = 0x0000;   // 改这里：mask全0 = 接收所有帧
...
static void Can_ProcessRx(void)
{
  ...
  while (HAL_CAN_GetRxFifoFillLevel(&hcan, CAN_RX_FIFO0) > 0U)
  {
    HAL_GPIO_TogglePin(LED_R_GPIO_Port, LED_R_Pin);  // 收到任何帧就翻转红灯
